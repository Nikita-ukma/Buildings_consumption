...
MAE: 696.76 MW
R²: 0.7935
Winter RMSE: 815.10 MW
Spring RMSE: 661.64 MW
Summer RMSE: 1357.23 MW
Fall RMSE: 839.83 MW

                   Feature  Importance
10          cooling_degree    0.036629
11  cooling_degree_squared    0.033604
1                  weekday    0.029770
8             Chicago_temp    0.029000
6                 hour_cos    0.028293
17                  lag_1y    0.012105
21        temp_rolling_24h    0.010383
2                  quarter    0.009666
22        temp_rolling_72h    0.008363
0                     hour    0.007564
'''
...
# Function to create time series sequences for GRU model
...
# GRU doesn't natively provide feature importance, so we'll use a custom approach
...
if __name__ == "__main__":
    try:
        ...
        # Choose sequence length (time steps) for the GRU model
        ...
        # Custom feature importance for GRU
