...
# Побудова моделі LightGBM
model = lgb.LGBMRegressor(random_state=42)

# Параметри для тюнінгу
param_dist = {
    'n_estimators': [100, 200, 300],  # Менше значень
    'max_depth': [3, 6, 9],           # Менше значень
    'learning_rate': [0.01, 0.05, 0.1],  # Менше значень
    'min_data_in_leaf': [20, 50],     # Менше значень
    'num_leaves': [31, 50, 100],      # Менше значень
    'subsample': [0.8, 0.9],          # Менше значень
    'colsample_bytree': [0.8, 0.9]    # Менше значень
}

# Використання GridSearchCV для більш точного пошуку
